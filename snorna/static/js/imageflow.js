...
function ImageFlow() {
    ...
    this.defaults =
	{
	    animationSpeed: 60,             /* Animation speed in ms */
	    aspectRatio: 1.8,          /* Aspect ratio of the ImageFlow container (width divided by height) */
	    buttons: false,          /* Toggle navigation buttons */
	    captions: false,           /* Toggle captions */
	    circular: true,          /* 循环 */
	    imageCursor: 'pointer',      /* Cursor type for all images - default is 'default' */
	    ImageFlowID: 'imageflow',    /* Default id of the ImageFlow container */
	    imageFocusM: 20.0,            /* Multiplicator for the focussed image size in percent */
	    imageFocusMax: 6,              /* 左右二侧图片数量 */
	    imagePath: '',             /* Path to the images relative to the reflect_.php script */
	    imageScaling: true,           /* Toggle image scaling */
	    imagesHeight: 0.56,           /* 高宽比例 */
	    imagesM: 0.95,            /* 图片深度 */
	    // onClick: function () { document.location = this.url; },   /* Onclick behaviour */
	    opacity: false,          /* Toggle image opacity */
	    opacityArray: [10, 8, 6, 4, 2],   /* Image opacity (range: 0 to 10) first value is for the focussed image */
	    percentLandscape: 134,            /* Scale landscape format */
	    percentOther: 80,            /* Scale portrait and square format */
	    preloadImages: true,           /* Toggles loading bar (false: requires img attributes height and width) */
	    reflections: true,           /* Toggle reflections */
	    reflectionGET: '',             /* Pass variables via the GET method to the reflect_.php script */
	    reflectionP: 0.6,            /* Height of the reflection in percent of the source image */
            ...
            if (my.imageScaling)
            {
                ...
                else
                {
                    try
                    {
                        ...
                        {
                            case false:
                                image.onclick = function () { my.glideTo(this.i); document.getElementById('pictext').innerHTML=this.id;};
                                break;
